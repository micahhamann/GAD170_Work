...
public class ShipManager : MonoBehaviour
{
    ...
    public void OnAcceptClick()
    {
        ...
        if(crewmate.isParasite && knownParasiteList.Count < 4)
        {

            audioManager.PlayParasiteSounds();
            ParasiteHired(crewmate.GetHobby());

            if (knownParasiteList.Count == 4)
            {
                GameOver();
            }
        }
        ...
        else
        {
            if (shipList.Count < 10)
            {
                ...
                if (shipList.Count == 10 && knownParasiteList.Count != 4)
                {
                    Victory();
                }
    ...
    public void OnNewRecruitClick()
    {
        ...
        crewmate.Setup();
        crewmate.SetParasiteCondition(difficulty);
    }
    ...
    public void ParasiteHired(string hobby)
    {
        ...
        knownParasiteList.Add(crewmate);
    ...
    public void OnNewGameClick()
    {
        ...
        for (int i = knownParasiteList.Count - 1; i >= 0; i--)
        {
